...
export const skillCategoryOptions: Array<{ id: SkillCategory; label: string }> = [
  { id: 'work', label: i18n.t('category.work') },
  { id: 'office', label: i18n.t('category.office') },
  { id: 'research', label: i18n.t('category.research') },
  { id: 'creative', label: i18n.t('category.creative') },
  { id: 'automation', label: i18n.t('category.automation') },
  { id: 'developer', label: i18n.t('category.developer') },
  { id: 'all', label: i18n.t('category.all') }
]
